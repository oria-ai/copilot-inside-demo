          ...
          {allModules.map((course) => {
            ...
            const feedbackContent = {
              'basics': {
                ...
                understanding: "נראה שהפרומפטים של העובד ברורים ומפורטים, הוא עדיין מתקשה במתן הקשר",
                recommendations: "להמשיך לתרגל כתיבת פרומפטים ומתן הקשר ברור, ניתן לפתוח העשרה על פרומפטים מתקדמים."
              },
              'excel': {
